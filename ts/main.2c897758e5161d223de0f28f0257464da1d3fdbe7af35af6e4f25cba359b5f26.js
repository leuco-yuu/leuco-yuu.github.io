(() => {
  // ns-hugo-imp:assets\ts\gallery.ts
  ...
  // ns-hugo-imp:assets\ts\createElement.ts
  ...
  // ns-hugo-imp:assets\ts\colorScheme.ts
  ...
  // ns-hugo-imp:assets\ts\scrollspy.ts
  ...
  // ns-hugo-imp:assets\ts\smoothAnchors.ts
