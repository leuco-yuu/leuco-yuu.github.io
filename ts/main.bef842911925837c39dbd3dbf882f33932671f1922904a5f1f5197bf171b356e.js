(() => {
  // ns-hugo-imp:/home/leuco/Blog/leuco-yuu.github.io/assets/ts/gallery.ts
  ...
  // ns-hugo-imp:/home/leuco/Blog/leuco-yuu.github.io/assets/ts/color.ts
  var colorsCache = {};
  ...
  // ns-hugo-imp:/home/leuco/Blog/leuco-yuu.github.io/assets/ts/menu.ts
  ...
  // ns-hugo-imp:/home/leuco/Blog/leuco-yuu.github.io/assets/ts/createElement.ts
  ...
  // ns-hugo-imp:/home/leuco/Blog/leuco-yuu.github.io/assets/ts/colorScheme.ts
  ...
  // ns-hugo-imp:/home/leuco/Blog/leuco-yuu.github.io/assets/ts/scrollspy.ts
  ...
  function setupScrollspy() {
    ...
    let scrollableNavigation = null;
    for (let i = 0; i < tocContainers.length; i++) {
      const container = tocContainers[i];
      if (container.offsetParent !== null && container.getBoundingClientRect().width > 0 && container.getBoundingClientRect().height > 0) {
        scrollableNavigation = container;
        break;
      }
    }
    if (!scrollableNavigation) {
      scrollableNavigation = tocContainers[0];
    }
  ...
  // ns-hugo-imp:/home/leuco/Blog/leuco-yuu.github.io/assets/ts/smoothAnchors.ts
